  ...
  theme: {
    extend: {
      colors: {
        ...
        // listingaudit-specific aliases
        teal: {
          DEFAULT: 'var(--accent-500)',
          soft:    'var(--accent-100)',
          deep:    'var(--accent-700)',
        },
        // Score-state colors (good/ok/bad) for scorecard tiles
        score: {
          good: 'var(--score-good)',
          ok:   'var(--score-ok)',
          bad:  'var(--score-bad)',
      ...
      fontSize: {
        ...
        // Big numeric for scorecard hero
        score: ['96px', { lineHeight: '1', letterSpacing: '-0.03em', fontWeight: '600' }],
      },
      spacing: {
        1: 'var(--sp-1)',
        2: 'var(--sp-2)',
