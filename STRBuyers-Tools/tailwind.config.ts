  ...
  theme: {
    extend: {
      colors: {
        ...
        // Finance-trust deeper-blue accent — strbuyers.tools delta.
        // Used for the Wordmark "STR Buyers" string and primary accent surfaces.
        accent: {
          DEFAULT: 'var(--brand-accent)',
          tint: 'var(--brand-accent-tint)',
          shade: 'var(--brand-accent-shade)',
