 ...
 *
 * Every calculator's inputs serialize to URL params. On change, debounce 200ms
 * and call history.replaceState. On page load, parse URL and seed inputs (fall
 * back to per-tool defaults).
 *
