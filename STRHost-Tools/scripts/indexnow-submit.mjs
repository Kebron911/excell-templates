#!/usr/bin/env node
/**
 * Post-deploy IndexNow submission for strhost.tools.
 *
 ...
 *
 * Verification flow:
 * 1. We host a file at https://strhost.tools/<KEY>.txt whose CONTENTS
...
const HOST = 'strhost.tools';
const KEY = '79e611376c54023468173bf8d3c0f85e';
